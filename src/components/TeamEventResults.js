...
class TeamEventResults extends PureComponent {
  render() {
    console.log("Render TeamEventResults")
...
TeamEventResults.propTypes = {
  classes: PropTypes.object.isRequired,
  status: PropTypes.object,
  awards: PropTypes.object,
}

export default withStyles(styles)(TeamEventResults)
